...
print("=" * 60)
print("CUSTOMER SUPPORT TRIAGE PIPELINE - SABOTAGE TEST")
print("=" * 60)
...
try:
    ...
    # Deliberately remove severity to test Gate 1.
    ctx.severity = None

    print("\nSABOTAGE APPLIED:")
    print("ctx.severity has been deliberately changed to None.")

    # Gate 1 should block the pipeline here.
    ...
    # ---------------------------------------------------------
    # STEP 2: CRM ENRICHER
    # This section should not run during the sabotage test.
    # ---------------------------------------------------------
    ...
    # Gate 2 must pass before the Drafter can run.
    gate_enrichment(ctx)
    ...
    # Gate 3 must pass before the Validator can run.
    gate_draft(ctx)
    ...
    print("\n" + "=" * 60)
    print("PIPELINE SABOTAGE TEST COMPLETED WITHOUT BLOCKING")
    print("=" * 60)
